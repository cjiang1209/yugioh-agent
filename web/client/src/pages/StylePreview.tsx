    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 3, justifyContent: "center" }}>
          {[0, 1, 2, 3].map(i => (
            <CardBack key={i} style={{ width: 28, height: 40, opacity: 0.6 }} />
          ))}
        </div>
        ...
        <div style={{ display: "flex", gap: 3, justifyContent: "center" }}>
          {[0, 1, 2, 3, 4].map(i => (
            <div
              key={i}
              style={{ ...zoneStyle, width: 44, height: 32, fontSize: 7 }}
            >
              S/T
            </div>
          ))}
        ...
        >
          {["DRAW", "STANDBY", "MAIN 1", "BATTLE", "MAIN 2", "END"].map(
            (p, i) => (
              <div
                key={p}
                style={{
        ...
        >
          ...
          <div style={{ display: "flex", gap: 4 }}>
            ...
            <div style={{ textAlign: "center" }}>
              <div
                style={{
                  ...
                  justifyContent: "center",
                  fontSize: 10,
                  boxShadow: `0 0 6px rgba(180,79,255,0.3)`,
                }}
              >
                ✦
              </div>
            ...
            <CardBack
              style={{
                border: `1px solid ${panelBorder}`,
                boxShadow: `0 0 4px rgba(0,245,255,0.15)`,
              }}
            />
          </div>
        </div>
          ...
          {SAMPLE_CARDS.map(c => (
            <CardFace
              ...
              style={{
                ...
                boxShadow: `0 0 5px rgba(255,179,71,0.15)`,
              }}
            />
          ))}
          <CardBack style={{ border: `1px solid rgba(255,179,71,0.2)` }} />
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: 24 }}>
        ...
        >
          Compare the three visual styles below, then tell me which one you
          prefer (or mix elements from multiple)
        </div>
      </div>
      ...
      >
        Card images are loaded live from YGOPRODeck API · Zone labels and LP
        bars reflect the actual board layout
      </div>
    </div>
  );
}
