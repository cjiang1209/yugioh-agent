"""Render leaderboard_data/index.md from entry files.
...
from .compare import compare_groups, format_comparison_table
from .entry import Entry, atomic_write_text, now_iso
from .features import GROUPING_FIELDS
