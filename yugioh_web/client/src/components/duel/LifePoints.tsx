...
export function LifePoints({ name, lp, maxLp = 8000, isActive, isOpponent, flash }: LifePointsProps) {
  ...
  return (
    <div
      ...
      style={{
        ...
        background: flash ? "rgba(255,45,120,0.18)" : isActive ? "rgba(0,245,255,0.05)" : "rgba(0,0,0,0.6)",
        ...
        boxShadow: flash
          ...
          : isActive ? "0 0 16px rgba(0,245,255,0.3), inset 0 0 10px rgba(0,245,255,0.03)" : "0 0 6px rgba(0,245,255,0.08)",
        minWidth: "clamp(120px, 18vw, 220px)",
        transition: "background 0.15s, border-color 0.15s, box-shadow 0.15s",
        animation: flash ? "lp-damage-flash 0.5s ease-out" : undefined,
      }}
    >
      <div className="flex items-center justify-between" style={{ marginBottom: "clamp(2px, 0.3vw, 5px)" }}>
        <span
          ...
          style={{
            ...
            letterSpacing: "0.1em",
            textShadow: isOpponent ? "0 0 6px rgba(255,45,120,0.6)" : "0 0 6px rgba(0,245,255,0.6)",
      ...
      <div
        ...
        style={{ height: "clamp(3px, 0.4vw, 5px)", background: "rgba(255,255,255,0.1)" }}
      >
        <div
