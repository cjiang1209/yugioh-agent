...
env-side reseed at ``environment.py:reset()``. ``evaluate`` reseeds
...
from .actor_learner import WorkerDiedError, WorkerTimeoutError
from .env_wrapper import DeckDict, EvalEnv
...
class EvalWorkerError(RuntimeError):
    ...
    :class:`rl.actor_learner.WorkerDiedError` (worker exited) and
    :class:`rl.actor_learner.WorkerTimeoutError` (alive but silent).
    """
...
def _eval_worker(
    ...
    *,
    ...
    Mirrors :func:`rl.actor_learner._actor_learner_worker`'s pipe
