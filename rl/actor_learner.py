...
from .policy_inputs import build_forward_inputs

if TYPE_CHECKING:
    import torch.nn as nn

    from .config import TrainingConfig
    from .env_wrapper import DeckDict
    from .network import HxState
    from .opponent_pool import Sampling
...
def _init_worker(env_kwargs, weight_handles, config_dict):
    ...
    from .config import TrainingConfig, normalize_legacy_config
    from .env_wrapper import TrainingEnv
    from .network import YuGiOhNet
    from .shared_weights import SharedPolicyWeights
...
class _BaseActorLearnerVecEnv:
    ...
    def __init__(
        ...
        from .env_wrapper import limit_worker_blas_threads
