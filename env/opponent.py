...
from core.action_categories import IDLE_SP_SUMMON, IDLE_SSET, IDLE_SUMMON
from core.constants import (
    MSG_SELECT_BATTLECMD,
    MSG_SELECT_IDLECMD,
)

from .models import Attack, CardCommand, PhaseChange, YuGiOhObservation
...
def make_opponent(
    ...
    *,
    ...
    if opponent_type == "ygo-agent":
        from .ygo_agent import YGOAgentOpponent
